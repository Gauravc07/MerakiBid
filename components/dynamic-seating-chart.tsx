...
const tablePositions: TablePosition[] = [
  ...
  { id: "50", x: 8, y: 8, width: 12, height: 12, shape: "rectangle", category: "Diamond" },
  { id: "51", x: 25, y: 8, width: 12, height: 12, shape: "rectangle", category: "Diamond" },
  { id: "52", x: 63, y: 8, width: 12, height: 12, shape: "rectangle", category: "Diamond" },
  { id: "53", x: 80, y: 8, width: 12, height: 12, shape: "rectangle", category: "Diamond" },

  // Second row - Platinum tables
  { id: "43/44", x: 2, y: 25, width: 15, height: 12, shape: "rectangle", category: "Platinum" },
  { id: "47/48", x: 83, y: 25, width: 15, height: 12, shape: "rectangle", category: "Platinum" }, // New table on right side
  { id: "82", x: 22, y: 32, width: 10, height: 10, shape: "circle", category: "Gold" },
  { id: "72", x: 68, y: 32, width: 10, height: 10, shape: "circle", category: "Gold" },

  // Third row
  { id: "41", x: 5, y: 58, width: 8, height: 8, shape: "circle", category: "Silver" },
  { id: "81", x: 18, y: 52, width: 12, height: 8, shape: "rectangle", category: "Gold" },
  { id: "71", x: 70, y: 52, width: 12, height: 8, shape: "rectangle", category: "Gold" },
  { id: "62", x: 87, y: 45, width: 8, height: 8, shape: "circle", category: "Silver" },

  // Fourth row - Table 42 positioned above table 41
  { id: "42", x: 5, y: 45, width: 8, height: 8, shape: "circle", category: "Silver" },
  { id: "63", x: 87, y: 58, width: 8, height: 8, shape: "circle", category: "Silver" },

  // Fifth row
  { id: "40", x: 5, y: 71, width: 8, height: 8, shape: "circle", category: "Silver" },
  { id: "80", x: 18, y: 68, width: 12, height: 8, shape: "rectangle", category: "Silver" },
  { id: "70", x: 70, y: 68, width: 12, height: 8, shape: "rectangle", category: "Silver" },
  { id: "64", x: 87, y: 71, width: 8, height: 8, shape: "circle", category: "Silver" },
]
    ...
    <div className="relative">
      ...
      <div className="relative w-full h-[600px] bg-black rounded-lg border-2 border-yellow-500 overflow-hidden">
        ...
        {tablePositions.map((position, index) => {
          ...
          return (
            <div
              key={`${position.id}-${position.x}-${position.y}-${index}`}
            ...
            >
              {/* Table content - Removed PAX count since it's in legend */}
